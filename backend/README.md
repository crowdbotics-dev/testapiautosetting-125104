...
## Project Structure
    ...
    ├── testapiautosetting_125104  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_125104`
...
2. Clone this repo and `cd testapiautosetting_125104`
